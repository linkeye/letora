...
import "./interfaces/ILetAccessControllerInterface.sol";
import "./interfaces/ILetFlagsInterface.sol";
 ...
 */
contract Flags is ILetFlagsInterface, SimpleReadAccessController {
  ILetAccessControllerInterface public raisingAccessController;
  ...
  function setRaisingAccessController(address racAddress) public override onlyOwner {
    ...
    if (previous != racAddress) {
      raisingAccessController = ILetAccessControllerInterface(racAddress);
