 ...
 */
contract SimpleWriteAccessController is ILetAccessControllerInterface, LetConfirmedOwner {
  ...
  constructor() LetConfirmedOwner(msg.sender) {
    checkEnabled = true;
  }
